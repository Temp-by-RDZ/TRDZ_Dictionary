...
class OpenOtherAppsTest {
    ...
    /**
     * Крайне ситуативный тест на отрытие другово приложения из меню
     * Не работает при кастомном меню и в зависимости от количества элементов нужна коррекция.
     */
    @Test
    fun test_OpenSettings() {
        uiDevice.pressHome()
        uiDevice.swipe(500, 1500, 500, 0, 5)
        val appViews = UiScrollable(UiSelector().scrollable(false)) //Корекция
